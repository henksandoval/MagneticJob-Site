!(function (e, t) {
  ...
  function r(e, t) {
    if (
      ((E(e) || e === window || e === document) && (e = [e]), L(e) || I(e) || (e = [e]), 0 != M(e))
    )
      if (L(e) && !I(e))
  ...
  var q = s(
      function e(t, n) {
        ...
        if (
          (i(this, e), (this.img = t), (this.slide = n), (this.onclose = l), this.img.setZoomEvents)
        )
          return !1;
        (this.active = !1),
          (this.zoomedIn = !1),
      ...
      [
        {
          ...
          value: function (e) {
            var t = e;
            return null !==
              (e = e.toLowerCase()).match(/\.(jpeg|jpg|jpe|gif|png|apn|webp|avif|svg)/)
              ? 'image'
            ...
            if (((this.isDoubleTap = !1), i > 1)) {
              ...
              null !== t.x &&
                (this.pinchStartLen > 0 &&
                  ((e.zoom = F(r) / this.pinchStartLen), this.pinch.dispatch(e, this.element)),
                (e.angle = R(r, t)),
      ...
      q = new U(X, {
          ...
          if (
            ...
            if (
              ...
              (window.innerWidth ||
                ...
                document.body.clientWidth) > 769 && (h = a.querySelector('.ginner-container')),
              c(Y, 'greset'),
        ...
        touchEnd: function () {
          if (r) {
            ...
            if (!(t > 29 && v))
              return t < 29 && i < 25 ? (d(Y, 'greset'), (Y.style.opacity = 1), $(h)) : void 0;
            e.close();
          }
        },
      ...
      [
        ...
        },
        {
          ...
          value: function () {
            ...
            (o = y(
              (o = (o = (o = o.replace(/{nextSVG}/g, n)).replace(/{prevSVG}/g, s)).replace(
                /{closeSVG}/g,
                l
              ))
            )),
                ...
                if (
                  ...
                  if (l <= 768) n.querySelector('img');
                    ...
                    var a,
                      ...
                      f =
                        null !== (a = v.getAttribute('data-height')) && void 0 !== a ? a : '100vh';
                    g.setAttribute('style', 'max-height: calc('.concat(f, ' - ').concat(h, 'px)')),
                      s.setAttribute('style', 'max-width: '.concat(g.offsetWidth, 'px;'));
                  }
                if (i) {
                  ...
                  if (
                    ...
                    i.parentNode.setAttribute('style', 'max-width: '.concat(L.width, 'px')),
                      r && s.setAttribute('style', 'max-width: '.concat(L.width, 'px;'));
                  } else
                    (i.parentNode.style.maxWidth = ''.concat(w)),
                      r && s.setAttribute('style', 'max-width: '.concat(w, ';'));
                }
              }
            }
          },
